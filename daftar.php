...
<meta charset="UTF-8">
    ...
    <style>
        ...
        table tr td{height: 27px;font-family: arial;font-size: 12px;text-align: center;}
...
<body>
    ...
    <table align="center" valign="middle" border="1px">
        ...
        <?php $sql = "SELECT * FROM admin";$result = mysqli_query($link, $sql);$num = mysqli_num_rows($result);
